...
class GlyphData:
    ...
    def __init__(self, char_code: int, bitmap: Optional[Image.Image] = None, is_edited: bool = False):
        ...
        self.radicals: List[str] = []  # [ADD] v1.06: 部首リスト
        self.variant_group: Optional[str] = None  # [ADD] v1.06: 異体字グループID
...
class FontProject:
    ...
    def __init__(self):
        ...
        # [ADD] v1.06: 部首インデックス {部首名: [char_code, ...]}
        self.radical_index: Dict[str, List[int]] = {}

        # [ADD] v1.06: 異体字グループ {group_id: [char_code, ...]}
...
<p>Generated by FontGen3 v1.06</p>
</body>
</html>'''
...
# ===== [BLOCK15-BEGIN] v1.06: 部首タグ付けダイアログ =====
