...
# -*- coding: utf-8 -*-
"""
フォントエディタ v1.07 - ハイブリッド方式
ビットマップ編集 → BDF/TTF書き出し対応
作成日: 2025-10-03
更新日: 2025-11-13 Phase3完成：部首タグ付け、部首検索、異体字マッピング
"""
...
# ===== GlyphEditorクラスの続き =====
    ...
    def _apply_noise_removal(self) -> None:
        ...
        try:
            ...
            # PIL画像に変換
            self.edit_bitmap = Image.fromarray(result.astype(np.uint8), mode='L')
