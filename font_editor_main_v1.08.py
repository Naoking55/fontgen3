...
# -*- coding: utf-8 -*-
"""
フォントエディタ v1.08 - ハイブリッド方式
ビットマップ編集 → BDF/TTF書き出し対応
作成日: 2025-10-03
更新日: 2025-11-17 v1.08: パフォーマンス・安定性改善
  - 一時ファイルのリーク防止
  - PhotoImage参照管理の統一
  - ピクセルループのNumPy最適化（10-100倍高速化）
  - 重い処理の非同期化（UIフリーズ解消）
  - グリッド描画の仮想スクロール実装
"""
...
class Config:
    ...
    # ===== [ADD] v1.04: 部首データベース（主要部首50個） =====
    MAJOR_RADICALS = {
        '一': {'unicode': 0x4E00, 'strokes': 1, 'name': '一（いち）'},
        '｜': {'unicode': 0xFF5C, 'strokes': 1, 'name': '｜（ぼう）'},
        '人': {'unicode': 0x4EBA, 'strokes': 2, 'name': '人（ひと）'},
        '亻': {'unicode': 0x4EBB, 'strokes': 2, 'name': '亻（にんべん）'},
        '口': {'unicode': 0x53E3, 'strokes': 3, 'name': '口（くち）'},
        '土': {'unicode': 0x571F, 'strokes': 3, 'name': '土（つち）'},
        '女': {'unicode': 0x5973, 'strokes': 3, 'name': '女（おんな）'},
        '子': {'unicode': 0x5B50, 'strokes': 3, 'name': '子（こ）'},
        '宀': {'unicode': 0x5B80, 'strokes': 3, 'name': '宀（うかんむり）'},
        '寸': {'unicode': 0x5BF8, 'strokes': 3, 'name': '寸（すん）'},
        '小': {'unicode': 0x5C0F, 'strokes': 3, 'name': '小（しょう）'},
        '尸': {'unicode': 0x5C38, 'strokes': 3, 'name': '尸（しかばね）'},
        '山': {'unicode': 0x5C71, 'strokes': 3, 'name': '山（やま）'},
        '川': {'unicode': 0x5DDD, 'strokes': 3, 'name': '川（かわ）'},
        '工': {'unicode': 0x5DE5, 'strokes': 3, 'name': '工（こう）'},
        '巾': {'unicode': 0x5DFE, 'strokes': 3, 'name': '巾（はば）'},
        '弓': {'unicode': 0x5F13, 'strokes': 3, 'name': '弓（ゆみ）'},
        '彳': {'unicode': 0x5F73, 'strokes': 3, 'name': '彳（ぎょうにんべん）'},
        '心': {'unicode': 0x5FC3, 'strokes': 4, 'name': '心（こころ）'},
        '忙': {'unicode': 0x5FD9, 'strokes': 4, 'name': '忄（りっしんべん）'},
        '手': {'unicode': 0x624B, 'strokes': 4, 'name': '手（て）'},
        '扌': {'unicode': 0x624C, 'strokes': 4, 'name': '扌（てへん）'},
        '日': {'unicode': 0x65E5, 'strokes': 4, 'name': '日（ひ）'},
        '月': {'unicode': 0x6708, 'strokes': 4, 'name': '月（つき）'},
        '木': {'unicode': 0x6728, 'strokes': 4, 'name': '木（き）'},
        '水': {'unicode': 0x6C34, 'strokes': 4, 'name': '水（みず）'},
        '氵': {'unicode': 0x6C35, 'strokes': 4, 'name': '氵（さんずい）'},
        '火': {'unicode': 0x706B, 'strokes': 4, 'name': '火（ひ）'},
        '灬': {'unicode': 0x706C, 'strokes': 4, 'name': '灬（れっか）'},
        '王': {'unicode': 0x738B, 'strokes': 4, 'name': '王（おう）'},
        '田': {'unicode': 0x7530, 'strokes': 5, 'name': '田（た）'},
        '目': {'unicode': 0x76EE, 'strokes': 5, 'name': '目（め）'},
        '石': {'unicode': 0x77F3, 'strokes': 5, 'name': '石（いし）'},
        '示': {'unicode': 0x793A, 'strokes': 5, 'name': '示（しめす）'},
        '礻': {'unicode': 0x793B, 'strokes': 5, 'name': '礻（しめすへん）'},
        '禾': {'unicode': 0x79BE, 'strokes': 5, 'name': '禾（のぎ）'},
        '穴': {'unicode': 0x7A74, 'strokes': 5, 'name': '穴（あな）'},
        '立': {'unicode': 0x7ACB, 'strokes': 5, 'name': '立（たつ）'},
        '竹': {'unicode': 0x7AF9, 'strokes': 6, 'name': '竹（たけ）'},
        '米': {'unicode': 0x7C73, 'strokes': 6, 'name': '米（こめ）'},
        '糸': {'unicode': 0x7CF8, 'strokes': 6, 'name': '糸（いと）'},
        '糹': {'unicode': 0x7CF9, 'strokes': 6, 'name': '糹（いとへん）'},
        '缶': {'unicode': 0x7F36, 'strokes': 6, 'name': '缶（ほとぎ）'},
        '耳': {'unicode': 0x8033, 'strokes': 6, 'name': '耳（みみ）'},
        '虫': {'unicode': 0x866B, 'strokes': 6, 'name': '虫（むし）'},
        '言': {'unicode': 0x8A00, 'strokes': 7, 'name': '言（ごん）'},
        '訁': {'unicode': 0x8A01, 'strokes': 7, 'name': '訁（ごんべん）'},
        '貝': {'unicode': 0x8C9D, 'strokes': 7, 'name': '貝（かい）'},
        '足': {'unicode': 0x8DB3, 'strokes': 7, 'name': '足（あし）'},
        '金': {'unicode': 0x91D1, 'strokes': 8, 'name': '金（かね）'},
        '釒': {'unicode': 0x91D2, 'strokes': 8, 'name': '釒（かねへん）'},
        '門': {'unicode': 0x9580, 'strokes': 8, 'name': '門（もん）'},
        '雨': {'unicode': 0x96E8, 'strokes': 8, 'name': '雨（あめ）'},
        '食': {'unicode': 0x98DF, 'strokes': 9, 'name': '食（しょく）'},
        '飠': {'unicode': 0x98E0, 'strokes': 9, 'name': '飠（しょくへん）'},
        '馬': {'unicode': 0x99AC, 'strokes': 10, 'name': '馬（うま）'},
        '魚': {'unicode': 0x9B5A, 'strokes': 11, 'name': '魚（さかな）'},
        '鳥': {'unicode': 0x9CE5, 'strokes': 11, 'name': '鳥（とり）'},
    }
...
class GlyphData:
    ...
    def __init__(self, char_code: int, bitmap: Optional[Image.Image] = None, is_edited: bool = False):
        ...
        self.radicals: List[str] = []  # [ADD] v1.07: 部首リスト
        self.variant_group: Optional[str] = None  # [ADD] v1.07: 異体字グループID
...
class FontProject:
    ...
    def __init__(self):
        ...
        # [ADD] v1.07: 部首インデックス {部首名: [char_code, ...]}
        self.radical_index: Dict[str, List[int]] = {}

        # [ADD] v1.07: 異体字グループ {group_id: [char_code, ...]}
        self.variant_groups: Dict[str, List[int]] = {}
    ...
    def _rebuild_radical_index(self):
        """部首インデックスを再構築 (v1.07)"""
        self.radical_index.clear()
        for char_code, glyph in self.glyphs.items():
            if hasattr(glyph, 'radicals'):
                for radical in glyph.radicals:
                    if radical not in self.radical_index:
                        self.radical_index[radical] = []
                    if char_code not in self.radical_index[radical]:
                        self.radical_index[radical].append(char_code)
...
class GridView(tk.Frame):
    ...
    def __init__(
        ...
        # PhotoImage参照管理（v1.08: GC対策で統一的に管理）
        self.thumb_cache: Dict[int, ImageTk.PhotoImage] = {}  # サムネイルキャッシュ
        self._photo_refs: List[ImageTk.PhotoImage] = []  # リストにも保持してGC防止
        ...
        # v1.08: 仮想スクロール用（遅延ロード）
        self._cell_widgets: Dict[int, tk.Frame] = {}  # セルウィジェットキャッシュ
        self._filtered_codes: List[int] = []  # フィルタ済みコードリスト
        self._render_batch_size = 50  # 一度に描画するセル数
    ...
    def refresh(self) -> None:
        ...
        # v1.08: 遅延ロードで段階的に描画（UIフリーズ防止）
        if len(self._filtered_codes) > self._render_batch_size:
            # 大量のセルがある場合は段階的に描画
            self._render_cells_batch(0, columns)
        else:
            # 少量の場合は一括描画
            for idx, code in enumerate(self._filtered_codes):
                row = idx // columns
                col = idx % columns
    ...
    def _render_cells_batch(self, start_idx: int, columns: int) -> None:
        """セルをバッチ描画（v1.08: 遅延ロードヘルパー）"""
        end_idx = min(start_idx + self._render_batch_size, len(self._filtered_codes))

        for idx in range(start_idx, end_idx):
            code = self._filtered_codes[idx]
            row = idx // columns
            col = idx % columns
            self._create_cell(code, row, col)
        ...
        # まだ描画するセルがあれば続行
        if end_idx < len(self._filtered_codes):
            # 次のバッチを少し遅延して描画（UIの応答性を維持）
            self.after(10, lambda: self._render_cells_batch(end_idx, columns))
        else:
            # 全セル描画完了
            self.scrollable_frame.update_idletasks()
            self.canvas.configure(scrollregion=self.canvas.bbox('all'))
...
class GlyphEditor(tk.Toplevel):
    ...
    def _setup_ui(self) -> None:
        ...
        # [ADD] v1.02: ビットマップ処理
        tk.Button(toolbar, text='フィルタ', command=self._show_filter_menu).pack(side='left', padx=2)
        # [ADD] v1.03: 太字/細字生成
        tk.Button(toolbar, text='太字/細字', command=self._show_bold_thin_generator).pack(side='left', padx=2)
        # [ADD] v1.07: 部首タグ付け
        tk.Button(toolbar, text='部首', command=self._show_radical_tagging).pack(side='left', padx=2)
...
# ===== GlyphEditorクラスの続き =====
    ...
    # ===== [ADD] v1.02: 高度なビットマップ処理 =====

    def _show_filter_menu(self) -> None:
        """フィルタメニューを表示"""
        menu = tk.Menu(self, tearoff=0)
        menu.add_command(label='ノイズ除去', command=self._apply_noise_removal)
        menu.add_command(label='メディアンフィルタ (3x3)', command=lambda: self._apply_median_filter(3))
        menu.add_command(label='メディアンフィルタ (5x5)', command=lambda: self._apply_median_filter(5))
        menu.add_command(label='エッジスムージング', command=self._apply_edge_smoothing)
        menu.add_command(label='自動トリミング', command=self._apply_auto_trim)
        menu.add_separator()
        menu.add_command(label='マルチサイズプレビュー...', command=self._show_multi_size_preview)

        # マウス位置にメニューを表示
        try:
            x = self.winfo_pointerx() - self.winfo_rootx()
            y = self.winfo_pointery() - self.winfo_rooty()
            menu.post(self.winfo_rootx() + x, self.winfo_rooty() + y)
        except:
            menu.post(self.winfo_rootx() + 100, self.winfo_rooty() + 100)

    def _apply_noise_removal(self) -> None:
        """ノイズ除去（モルフォロジー演算：オープニング）v1.08: 非同期化"""
        # アンドゥに保存
        self._save_to_undo()
        ...
        tk.Label(progress_dialog, text='ノイズ除去処理中...', font=('Arial', 12)).pack(pady=20)
        ...
        def worker():
            try:
                # numpy配列に変換
                img_array = np.array(self.edit_bitmap)

                # 二値化（閾値128）
                binary = (img_array < 128).astype(np.uint8)

                # モルフォロジー演算：Opening（侵食→膨張）でノイズ除去
                # 3x3の構造要素を使用
                ...
                # 膨張
                opened = self._morphology_dilate(eroded, kernel)
                ...
                # GUI更新（メインスレッドで実行）
                def update_gui():
                    self.edit_bitmap = result_img
                    self._update_preview()
                    progress_dialog.destroy()
                    messagebox.showinfo('成功', 'ノイズ除去を適用しました')
                ...
                def show_error():
                    progress_dialog.destroy()
                    messagebox.showerror('エラー', f'ノイズ除去エラー:\n{str(e)}')
    ...
    def _morphology_erode(self, binary: np.ndarray, kernel: np.ndarray) -> np.ndarray:
        """侵食処理（簡易実装）"""
        h, w = binary.shape
        kh, kw = kernel.shape
    ...
    def _morphology_dilate(self, binary: np.ndarray, kernel: np.ndarray) -> np.ndarray:
        """膨張処理（簡易実装）"""
        h, w = binary.shape
        kh, kw = kernel.shape
        pad_h, pad_w = kh // 2, kw // 2
    ...
    def _apply_median_filter(self, size: int) -> None:
        """メディアンフィルタ適用"""
        try:
            # アンドゥに保存
            self._save_to_undo()
            ...
            # PILのメディアンフィルタを適用
            self.edit_bitmap = self.edit_bitmap.filter(ImageFilter.MedianFilter(size=size))

            # プレビュー更新
            self._update_preview()

            messagebox.showinfo('成功', f'メディアンフィルタ ({size}x{size}) を適用しました')

        except Exception as e:
            messagebox.showerror('エラー', f'メディアンフィルタエラー:\n{str(e)}')

    def _apply_edge_smoothing(self) -> None:
        """エッジスムージング"""
        try:
            # アンドゥに保存
            self._save_to_undo()

            # PILのSMOOTHフィルタとSHARPENフィルタを組み合わせ
            smoothed = self.edit_bitmap.filter(ImageFilter.SMOOTH)

            # さらにGaussianBlurで微調整
            self.edit_bitmap = smoothed.filter(ImageFilter.GaussianBlur(radius=0.5))

            # プレビュー更新
            self._update_preview()

            messagebox.showinfo('成功', 'エッジスムージングを適用しました')

        except Exception as e:
            messagebox.showerror('エラー', f'エッジスムージングエラー:\n{str(e)}')
    ...
    def _apply_auto_trim(self) -> None:
        ...
        try:
            ...
            if bbox is None:
                messagebox.showinfo('情報', '画像が空白のため、トリミングできません')
                return

            # トリミング
            cropped = self.edit_bitmap.crop(bbox)

            # 新しい白背景画像を作成
            new_img = Image.new('L', (Config.CANVAS_SIZE, Config.CANVAS_SIZE), 255)

            # 中央に配置
            x = (Config.CANVAS_SIZE - cropped.width) // 2
            y = (Config.CANVAS_SIZE - cropped.height) // 2
            ...
            messagebox.showinfo('成功', f'自動トリミングを適用しました\n元のサイズ: {bbox[2]-bbox[0]}x{bbox[3]-bbox[1]}px')

        except Exception as e:
            messagebox.showerror('エラー', f'自動トリミングエラー:\n{str(e)}')

    def _show_multi_size_preview(self) -> None:
        """マルチサイズプレビューダイアログを表示"""
        MultiSizePreviewDialog(self, self.edit_bitmap, self.char_code)

    def _show_bold_thin_generator(self) -> None:
        """太字/細字生成ダイアログを表示"""
        dialog = BoldThinGeneratorDialog(self, self.edit_bitmap)
        ...
        if dialog.result:
            ...
            self._save_to_undo()
            # 生成された画像を適用
            self.edit_bitmap = dialog.result
            # プレビュー更新
            self._update_preview()

    def _show_radical_tagging(self) -> None:
        """部首タグ付けダイアログを表示"""
        # 現在のグリフを取得
        glyph = self.project.glyphs.get(self.char_code)
        if not glyph:
            messagebox.showinfo('情報', 'グリフが読み込まれていません')
            return

        dialog = RadicalTaggingDialog(self, glyph, self.project)
        self.wait_window(dialog)

        # ダイアログで変更があった場合、プロジェクトのインデックスを更新
        if dialog.modified:
            self.project._rebuild_radical_index()
...
class FontEditorApp(tk.Tk):
    ...
    def _setup_ui(self) -> None:
        ...
        # [ADD] v1.07: 部首・異体字管理
        view_menu.add_command(label='部首検索...', command=self._show_radical_search)
        view_menu.add_command(label='異体字グループ管理...', command=self._show_variant_groups)
    ...
    def _show_radical_search(self) -> None:
        """部首検索ダイアログを表示 [ADD] v1.07"""
        if not self.project.glyphs:
            messagebox.showwarning('警告', 'フォントが読み込まれていません')
            return

        dialog = RadicalSearchDialog(self, self.project)
        self.wait_window(dialog)

        # 検索結果でフィルタを更新
        if hasattr(dialog, 'selected_codes') and dialog.selected_codes is not None:
            # カスタムフィルタを作成して適用
            def radical_filter(code: int) -> bool:
                return code in dialog.selected_codes
            self.current_filter = radical_filter
            self.grid_view.set_filter(self.current_filter)

    def _show_variant_groups(self) -> None:
        """異体字グループ管理ダイアログを表示 [ADD] v1.07"""
        if not self.project.glyphs:
            messagebox.showwarning('警告', 'フォントが読み込まれていません')
            return

        VariantGroupManagementDialog(self, self.project)
        ...
        for name in part_names:
            ...
            if name not in self._thumb_cache:
                try:
                    ...
                    alpha = 255 - gray_array

                    # RGBA配列を作成
                    rgba_array = np.zeros((*gray_array.shape, 4), dtype=np.uint8)
                    rgba_array[:, :, 3] = alpha  # アルファチャンネル
                ...
                if img:
                    ...
                    try:
                        ...
                        with tempfile.NamedTemporaryFile(suffix='.bmp', delete=False) as tmp_bmp:
                            ...
                            img.convert('1').save(tmp_bmp_path, 'BMP')
...
<p>Generated by FontGen3 v1.07</p>
</body>
</html>'''
...
class TextPreviewDialog(tk.Toplevel):
    ...
    def _save_png(self) -> None:
        ...
        # 透過PNG変換（v1.08: NumPy最適化で10-100倍高速化）
        gray_array = np.array(combined)
        alpha = 255 - gray_array
...
# ===== [BLOCK13-BEGIN] v1.02: マルチサイズプレビューダイアログ =====

class MultiSizePreviewDialog(tk.Toplevel):
    """マルチサイズプレビューダイアログ - 複数サイズ同時表示、アンチエイリアス比較"""

    def __init__(self, parent: tk.Widget, bitmap: Image.Image, char_code: int) -> None:
        super().__init__(parent)
        self.bitmap = bitmap
        self.char_code = char_code

        self.title(f'マルチサイズプレビュー - U+{char_code:04X}')
    ...
    def _setup_ui(self) -> None:
        ...
        tk.Label(
            header,
            text=f'文字: {chr(self.char_code)} (U+{self.char_code:04X})',
            font=('Arial', 14, 'bold'),
            bg=Config.COLOR_BG
        ).pack()
        ...
        for size in sizes:
            self._create_size_preview(scrollable_frame, size)
    ...
    def _create_size_preview(self, parent: tk.Frame, size: int) -> None:
        """サイズ別プレビューを作成"""
        # フレーム
        ...
        # タイトル
        title_frame = tk.Frame(frame, bg=Config.COLOR_BG)
        ...
        # ビットマップ（アンチエイリアスなし）
        bitmap_frame = tk.LabelFrame(preview_frame, text='ビットマップ', bg='white')
        bitmap_frame.pack(side='left', padx=10, pady=5)

        bitmap_resized = self.bitmap.resize((size, size), Image.Resampling.NEAREST)
        # 表示用に拡大
        bitmap_display = bitmap_resized.resize((size*4, size*4), Image.Resampling.NEAREST)
        bitmap_photo = ImageTk.PhotoImage(bitmap_display)
        self.photo_refs.append(bitmap_photo)

        tk.Label(bitmap_frame, image=bitmap_photo, bg='white').pack(padx=10, pady=10)

        # アンチエイリアス（LANCZOS）
        aa_lanczos_frame = tk.LabelFrame(preview_frame, text='アンチエイリアス (LANCZOS)', bg='white')
        aa_lanczos_frame.pack(side='left', padx=10, pady=5)

        aa_lanczos = self.bitmap.resize((size, size), Image.Resampling.LANCZOS)
        # 表示用に拡大
        aa_lanczos_display = aa_lanczos.resize((size*4, size*4), Image.Resampling.NEAREST)
        aa_lanczos_photo = ImageTk.PhotoImage(aa_lanczos_display)
        self.photo_refs.append(aa_lanczos_photo)

        tk.Label(aa_lanczos_frame, image=aa_lanczos_photo, bg='white').pack(padx=10, pady=10)

        # アンチエイリアス（BILINEAR）
        aa_bilinear_frame = tk.LabelFrame(preview_frame, text='アンチエイリアス (BILINEAR)', bg='white')
        aa_bilinear_frame.pack(side='left', padx=10, pady=5)

        aa_bilinear = self.bitmap.resize((size, size), Image.Resampling.BILINEAR)
        # 表示用に拡大
        aa_bilinear_display = aa_bilinear.resize((size*4, size*4), Image.Resampling.NEAREST)
        aa_bilinear_photo = ImageTk.PhotoImage(aa_bilinear_display)
        self.photo_refs.append(aa_bilinear_photo)

        tk.Label(aa_bilinear_frame, image=aa_bilinear_photo, bg='white').pack(padx=10, pady=10)
...
# ===== [BLOCK14-BEGIN] v1.03: 太字/細字生成ダイアログ =====

class BoldThinGeneratorDialog(tk.Toplevel):
    """太字/細字自動生成ダイアログ - ウェイト調整とプレビュー"""

    def __init__(self, parent: tk.Widget, bitmap: Image.Image) -> None:
        super().__init__(parent)
        self.original_bitmap = bitmap.copy()
        ...
        # 現在の設定
        self.mode_var = tk.StringVar(value='bold')  # 'bold' or 'thin'
        self.weight_var = tk.IntVar(value=2)  # カーネルサイズ（1-5）
    ...
    def _setup_ui(self) -> None:
        ...
        # モード選択
        mode_frame = tk.LabelFrame(control_frame, text='モード', bg=Config.COLOR_BG)
        ...
        # ウェイト調整
        weight_frame = tk.LabelFrame(control_frame, text='ウェイト調整', bg=Config.COLOR_BG)
        weight_frame.pack(side='left', padx=10, pady=5, fill='both', expand=True)
        ...
        self.weight_scale.pack(padx=10, pady=5)
        ...
        # オリジナル
        original_frame = tk.LabelFrame(preview_frame, text='オリジナル', bg='white')
        original_frame.pack(side='left', padx=10, pady=5, fill='both', expand=True)

        self.original_canvas = tk.Canvas(original_frame, bg='white', width=300, height=300)
        self.original_canvas.pack(padx=10, pady=10)

        # 生成結果
        result_frame = tk.LabelFrame(preview_frame, text='生成結果', bg='white')
        result_frame.pack(side='left', padx=10, pady=5, fill='both', expand=True)

        self.result_canvas = tk.Canvas(result_frame, bg='white', width=300, height=300)
    ...
    def _update_preview(self) -> None:
        """プレビュー更新（v1.08: 非同期化でUIフリーズ解消）"""
        # 既に処理中の場合は保留
        if self._processing:
            if self._pending_update:
                self.after_cancel(self._pending_update)
            # 少し遅延して再試行
            self._pending_update = self.after(100, self._update_preview)
            return
        ...
        self.weight_label.config(text=f'ウェイト: {weight}')

        # オリジナル表示
        original_display = self.original_bitmap.resize((256, 256), Image.Resampling.NEAREST)
        original_photo = ImageTk.PhotoImage(original_display)
        self.photo_refs['original'] = original_photo
        self.original_canvas.delete('all')
        self.original_canvas.create_image(150, 150, image=original_photo)

        # 処理中表示
        self.result_canvas.delete('all')
        self.result_canvas.create_text(150, 150, text='処理中...', font=('Arial', 16))
        ...
        def worker():
            try:
                if mode == 'bold':
                    generated = self._generate_bold(self.original_bitmap, weight)
                else:
                    generated = self._generate_thin(self.original_bitmap, weight)

                # GUI更新（メインスレッドで実行）
                def update_gui():
                    try:
                        # 結果表示
                        result_display = generated.resize((256, 256), Image.Resampling.NEAREST)
                        result_photo = ImageTk.PhotoImage(result_display)
                        self.photo_refs['result'] = result_photo
                        self.result_canvas.delete('all')
                        self.result_canvas.create_image(150, 150, image=result_photo)

                        # 結果を保存
                        self.result_temp = generated
                    finally:
                        self._processing = False
                ...
                def show_error():
                    self.result_canvas.delete('all')
                    self.result_canvas.create_text(150, 150, text=f'エラー:\n{str(e)}',
...
# ===== [BLOCK15-BEGIN] v1.07: 部首タグ付けダイアログ =====

class RadicalTaggingDialog(tk.Toplevel):
    """部首タグ付けダイアログ"""

    def __init__(self, parent: tk.Widget, glyph: GlyphData, project: FontProject) -> None:
        super().__init__(parent)
        self.glyph = glyph
        self.project = project
        self.modified = False

        self.title(f'部首タグ付け - {glyph.get_char()} (U+{glyph.char_code:04X})')
        self.geometry('600x500')

        self.radical_vars: Dict[str, tk.BooleanVar] = {}
        self._setup_ui()
    ...
    def _setup_ui(self) -> None:
        ...
        tk.Label(header, text=f'文字: {self.glyph.get_char()}  (U+{self.glyph.char_code:04X})',
                 font=('Arial', 14, 'bold'), bg=Config.COLOR_BG).pack()
        ...
        # 画数でグループ化
        radicals_by_stroke = {}
        for radical, info in Config.MAJOR_RADICALS.items():
            strokes = info['strokes']
            if strokes not in radicals_by_stroke:
                radicals_by_stroke[strokes] = []
            radicals_by_stroke[strokes].append((radical, info))

        # 画数順に表示
        for strokes in sorted(radicals_by_stroke.keys()):
            stroke_frame = tk.LabelFrame(scrollable_frame, text=f'{strokes}画', bg='white', font=('Arial', 11, 'bold'))
            stroke_frame.pack(fill='x', padx=5, pady=5)

            for radical, info in radicals_by_stroke[strokes]:
                var = tk.BooleanVar(value=radical in self.glyph.radicals)
                self.radical_vars[radical] = var
                cb = tk.Checkbutton(stroke_frame, text=f'{radical} - {info["name"]}', variable=var, bg='white', font=('Arial', 10))
                cb.pack(anchor='w', padx=10, pady=2)

        # ボタン
        button_frame = tk.Frame(self)
        button_frame.pack(pady=10)
        tk.Button(button_frame, text='保存', command=self._save, width=10).pack(side='left', padx=5)
        tk.Button(button_frame, text='キャンセル', command=self.destroy, width=10).pack(side='left', padx=5)

    def _save(self) -> None:
        """保存"""
        selected_radicals = [radical for radical, var in self.radical_vars.items() if var.get()]
        self.glyph.radicals = selected_radicals
        self.modified = True
        messagebox.showinfo('成功', f'{len(selected_radicals)}個の部首をタグ付けしました')
        self.destroy()


class RadicalSearchDialog(tk.Toplevel):
    """部首検索ダイアログ [ADD] v1.07"""

    def __init__(self, parent: tk.Widget, project: FontProject) -> None:
        super().__init__(parent)
        self.project = project
        self.selected_codes: Optional[Set[int]] = None
    ...
    def _setup_ui(self) -> None:
        ...
        tk.Label(header, text='部首を選択してグリフを検索',
                 font=('Arial', 14, 'bold'), bg=Config.COLOR_BG).pack()
        ...
        tk.Label(left_frame, text='部首を選択:', font=('Arial', 11, 'bold')).pack(anchor='w')
        ...
        # 画数順に表示
        for strokes in sorted(radicals_by_stroke.keys()):
            stroke_frame = tk.LabelFrame(scrollable_frame, text=f'{strokes}画', bg='white', font=('Arial', 10, 'bold'))
            stroke_frame.pack(fill='x', padx=5, pady=5)

            for radical, info in radicals_by_stroke[strokes]:
                var = tk.BooleanVar(value=False)
                self.radical_vars[radical] = var
                cb = tk.Checkbutton(stroke_frame, text=f'{radical} - {info["name"]}',
        ...
        tk.Label(right_frame, text='検索結果:', font=('Arial', 11, 'bold')).pack(anchor='w')

        self.result_text = tk.Text(right_frame, width=30, height=20, wrap='word', state='disabled')
        result_scrollbar = tk.Scrollbar(right_frame, command=self.result_text.yview)
        ...
        button_frame = tk.Frame(self)
        button_frame.pack(pady=10)
        tk.Button(button_frame, text='フィルタ適用', command=self._apply_filter, width=12).pack(side='left', padx=5)
        tk.Button(button_frame, text='閉じる', command=self.destroy, width=12).pack(side='left', padx=5)
    ...
    def _update_results(self) -> None:
        ...
        if not selected_radicals:
            ...
            self.result_text.insert('1.0', '部首を選択してください')
            self.result_text.config(state='disabled')
            return

        # 部首インデックスを再構築（必要な場合）
        if not self.project.radical_index:
            self.project._rebuild_radical_index()

        # 全ての選択された部首を含むグリフを検索
        matching_codes: Optional[Set[int]] = None
        for radical in selected_radicals:
            codes = set(self.project.radical_index.get(radical, []))
            if matching_codes is None:
                matching_codes = codes
            else:
                matching_codes &= codes  # AND条件（全ての部首を含む）

        if not matching_codes:
            self.result_text.config(state='normal')
            self.result_text.delete('1.0', 'end')
            self.result_text.insert('1.0', '該当するグリフが見つかりません')
            self.result_text.config(state='disabled')
            return
        ...
        result_lines = [f'該当グリフ: {len(matching_codes)}個\n\n']
        for code in sorted(matching_codes):
            glyph = self.project.glyphs.get(code)
            if glyph:
                char = glyph.get_char()
                result_lines.append(f'{char}  U+{code:04X}\n')

        self.result_text.insert('1.0', ''.join(result_lines))
        self.result_text.config(state='disabled')
    ...
    def _apply_filter(self) -> None:
        ...
        if not selected_radicals:
            messagebox.showinfo('情報', '部首を選択してください')
            return
        ...
        if not matching_codes:
            messagebox.showinfo('情報', '該当するグリフが見つかりません')
            return

        self.selected_codes = matching_codes
        messagebox.showinfo('成功', f'{len(matching_codes)}個のグリフにフィルタを適用します')
        self.destroy()


class VariantGroupManagementDialog(tk.Toplevel):
    """異体字グループ管理ダイアログ [ADD] v1.07"""
    ...
    def _setup_ui(self) -> None:
        ...
        tk.Label(header, text='異体字グループ管理',
                 font=('Arial', 14, 'bold'), bg=Config.COLOR_BG).pack()
        ...
        tk.Label(left_frame, text='グループ一覧:', font=('Arial', 11, 'bold')).pack(anchor='w')

        list_frame = tk.Frame(left_frame)
        list_frame.pack(fill='both', expand=True)

        self.group_listbox = tk.Listbox(list_frame, font=('Arial', 10))
        list_scrollbar = tk.Scrollbar(list_frame, command=self.group_listbox.yview)
        ...
        tk.Button(left_button_frame, text='新規グループ', command=self._create_group, width=12).pack(side='left', padx=2)
        tk.Button(left_button_frame, text='削除', command=self._delete_group, width=12).pack(side='left', padx=2)

        # 右側: グループメンバー
        right_frame = tk.Frame(main_frame)
        right_frame.pack(side='right', fill='both', expand=True, padx=(5, 0))

        tk.Label(right_frame, text='グループメンバー:', font=('Arial', 11, 'bold')).pack(anchor='w')

        member_frame = tk.Frame(right_frame)
        member_frame.pack(fill='both', expand=True)

        self.member_listbox = tk.Listbox(member_frame, font=('Arial', 10))
        member_scrollbar = tk.Scrollbar(member_frame, command=self.member_listbox.yview)
        self.member_listbox.config(yscrollcommand=member_scrollbar.set)
        ...
        tk.Button(right_button_frame, text='グリフ追加', command=self._add_member, width=12).pack(side='left', padx=2)
        tk.Button(right_button_frame, text='削除', command=self._remove_member, width=12).pack(side='left', padx=2)

        # 下部: 閉じるボタン
        button_frame = tk.Frame(self)
        button_frame.pack(pady=10)
        tk.Button(button_frame, text='閉じる', command=self.destroy, width=12).pack()

    def _refresh_group_list(self) -> None:
        """グループリストを更新"""
        self.group_listbox.delete(0, 'end')
        for group_name in sorted(self.project.variant_groups.keys()):
            member_count = len(self.project.variant_groups[group_name])
            self.group_listbox.insert('end', f'{group_name} ({member_count}個)')
    ...
    def _on_group_selected(self, event) -> None:
        ...
        member_codes = self.project.variant_groups.get(group_name, [])
        for code in member_codes:
            glyph = self.project.glyphs.get(code)
            if glyph:
                char = glyph.get_char()
                self.member_listbox.insert('end', f'{char}  U+{code:04X}')
    ...
    def _create_group(self) -> None:
        ...
        tk.Label(dialog, text='グループ名:', font=('Arial', 10)).pack(pady=10)
        ...
        def create():
            ...
            if not group_name:
                messagebox.showwarning('警告', 'グループ名を入力してください', parent=dialog)
                return
            if group_name in self.project.variant_groups:
                messagebox.showwarning('警告', 'そのグループ名は既に存在します', parent=dialog)
                return

            self.project.variant_groups[group_name] = []
            self._refresh_group_list()
            messagebox.showinfo('成功', f'グループ「{group_name}」を作成しました', parent=dialog)
            dialog.destroy()

        button_frame = tk.Frame(dialog)
        button_frame.pack(pady=10)
        tk.Button(button_frame, text='作成', command=create, width=10).pack(side='left', padx=5)
        tk.Button(button_frame, text='キャンセル', command=dialog.destroy, width=10).pack(side='left', padx=5)
    ...
    def _delete_group(self) -> None:
        ...
        selection = self.group_listbox.curselection()
        if not selection:
            messagebox.showinfo('情報', 'グループを選択してください')
            return

        selected_text = self.group_listbox.get(selection[0])
        group_name = selected_text.split(' (')[0]

        if messagebox.askyesno('確認', f'グループ「{group_name}」を削除しますか？'):
            # グループに属するグリフのvariant_groupをクリア
            member_codes = self.project.variant_groups.get(group_name, [])
            for code in member_codes:
                glyph = self.project.glyphs.get(code)
                if glyph and glyph.variant_group == group_name:
                    glyph.variant_group = None

            del self.project.variant_groups[group_name]
            self._refresh_group_list()
            self.member_listbox.delete(0, 'end')
            messagebox.showinfo('成功', f'グループ「{group_name}」を削除しました')
    ...
    def _add_member(self) -> None:
        ...
        tk.Label(dialog, text='グリフのコードポイントを入力:', font=('Arial', 10)).pack(pady=10)
        tk.Label(dialog, text='(例: U+4E00 または 0x4E00 または 20000)', font=('Arial', 8)).pack()
        ...
        def add():
            ...
            if not code_str:
                messagebox.showwarning('警告', 'コードポイントを入力してください', parent=dialog)
                return

            try:
                # 様々な形式に対応
                if code_str.upper().startswith('U+'):
                    char_code = int(code_str[2:], 16)
                elif code_str.startswith('0x') or code_str.startswith('0X'):
                    char_code = int(code_str, 16)
                else:
                    char_code = int(code_str)

                if char_code not in self.project.glyphs:
                    messagebox.showwarning('警告', f'コード {char_code:04X} のグリフは存在しません', parent=dialog)
                    return

                if char_code in self.project.variant_groups[group_name]:
                    messagebox.showinfo('情報', 'そのグリフは既にグループに含まれています', parent=dialog)
                    return

                # グループに追加
                self.project.variant_groups[group_name].append(char_code)
                glyph = self.project.glyphs[char_code]
                glyph.variant_group = group_name

                self._refresh_group_list()
                self._on_group_selected(None)  # メンバーリストを更新
                messagebox.showinfo('成功', f'グリフを追加しました', parent=dialog)
                dialog.destroy()

            except ValueError:
                messagebox.showerror('エラー', '無効なコードポイント形式です', parent=dialog)

        button_frame = tk.Frame(dialog)
        button_frame.pack(pady=10)
        tk.Button(button_frame, text='追加', command=add, width=10).pack(side='left', padx=5)
        tk.Button(button_frame, text='キャンセル', command=dialog.destroy, width=10).pack(side='left', padx=5)
    ...
    def _remove_member(self) -> None:
        ...
        member_selection = self.member_listbox.curselection()
        if not member_selection:
            messagebox.showinfo('情報', '削除するグリフを選択してください')
            return

        selected_text = self.group_listbox.get(group_selection[0])
        group_name = selected_text.split(' (')[0]

        member_text = self.member_listbox.get(member_selection[0])
        # "文字  U+XXXX" から U+XXXX を抽出
        code_str = member_text.split('U+')[1]
        char_code = int(code_str, 16)

        # グループから削除
        if char_code in self.project.variant_groups[group_name]:
            self.project.variant_groups[group_name].remove(char_code)
            glyph = self.project.glyphs.get(char_code)
            if glyph and glyph.variant_group == group_name:
                glyph.variant_group = None
            ...
            messagebox.showinfo('成功', 'グリフを削除しました')
